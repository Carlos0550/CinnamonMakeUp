...
function ProductModal({ product, closeModal }) {
  const { addToCart,sessionId } = useAppContext()
      ...
      <div className="modal-card box">
        ...
        <section className="modal-card-body box">
          <div className="content label box">
            ...
            <span className='tag is-danger' onClick={() => handleAddToCart(product.nombreProducto, product.publicUrl, product.precioProducto)}>
